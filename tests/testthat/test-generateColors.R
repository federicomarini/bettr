test_that("generateColors works", {
    expect_identical(.gg_color_hue(3),
    ...
    expect_identical(gc$colC(3), "#A1A1A1FF")
    expect_type(gc$colD, "closure")
    expect_identical(gc$colD(2), "#FFFFFFFF")
    expect_identical(gc$colD(7), "#A08EDFFF")
    ...
    expect_type(gc$colC, "closure")
    expect_identical(gc$colC(3), "#5B5B5BFF")
    expect_type(gc$colD, "closure")
    expect_identical(gc$colD(2), "#FFFFFFFF")
    expect_identical(gc$colD(7), "#8B8B8BFF")
})
