...
- Move the “Highlight method” UI inside the parallel coordinates plot
  tab
...
- Introduce
  ...
  for JSON serialization of `SummarizedExperiment` objects
- Support `jsonUrl` and `jsonFile` URL parameters for automatic data
  loading
...
- Add
  [`assembleSE()`](https://federicomarini.github.io/bettr/reference/assembleSE.md)
  function to create a summary SE

## bettr 0.3.0

- Add
  [`bettrGetReady()`](https://federicomarini.github.io/bettr/reference/bettrGetReady.md)
  function to prepare data for plotting independently of the shiny app
...
- Add more score aggregation methods (weighted median, weighted fraction
  that the method is the best one)
