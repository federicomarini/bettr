...
by averaging the different performance metrics, putting more emphasis on those 
that are more important to the specific situation. 
...
Here, the summary `data.frame` (provided in the `assay` of the 
`SummarizedExperiment` object) contains values for 48 performance 
