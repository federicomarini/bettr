...
different metrics and data sets. Finally, we need to transform the metrics in 
...
value for each metric class, to reduce the reduncancy. We can now also 
