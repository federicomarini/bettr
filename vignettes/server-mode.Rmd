---
title: "Server Mode Guide for bettr"
author: "bettr package authors"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Server Mode Guide for bettr}
...
The bettr package includes a pre-exported JSON file from the DuoClustering2018
dataset that can be used for testing and examples.

```{r url-jsonfile-example}
# Start server
bettr(serverMode = TRUE)
